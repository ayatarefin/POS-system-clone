                    ...
                    <div class="card w-100">
                        <div class="card-body">
                            <div class="d-sm-flex d-block align-items-center justify-content-between mb-9">
                                ...
                                <div>
                                    @php $items = DB::table('items')->get();@endphp
                                </div>
                            </div>
                            <div class="d-sm-flex d-block align-items-center justify-content-between mb-9">
                                <div class="row col-md-12">
                                    <div class="col-md-3">
                                        ...
                                        <input onchange="dailySaleChart()" onmouseleave="dailySaleChart()"
                                            value="{{date('Y-m-01')}}" type="date" name="fromDate"
                                            class="form-control" />
                                    </div>
                                    <div class="col-md-3">
                                        <label>To Date</label>
                                        <input id="actionPerform" onmouseleave="dailySaleChart()"
                                            onchange="dailySaleChart()" value="{{date('Y-m-d')}}" type="date"
                                            name="toDate" class="form-control" />
                                    </div>
                                    <div class="col-md-3">
                                        <label>Product Name</label>
                                        <select onchange="dailySaleChart()" class="form-select" name="name">
